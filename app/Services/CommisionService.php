...
class CommisionService
{
    ...
    public function saveAmount(int $accountId): bool 
    {
        ...
        $start = $this->timerService->convertTime($this->timerService->getCurrentTime(), TimerService::FORMAT_TIME); //current datetime

        $stop = $this->timerService->convertTime($this->timerService->getFutureTime($this->timerService->countDay), TimerService::FORMAT_TIME); //datetime + countDay
